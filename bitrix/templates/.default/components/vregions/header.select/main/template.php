...
<? if (!empty($arResult["ITEMS"])){ ?>
	<div class="vregion-popup-link" data-rand="<?=$rand;?>">
		<i class="flaticon-location4"></i>
		<a class="popup-region-open" href="#"
		   onclick="OpenVregionsPopUp('open', 'vregions-popup<?=$rand;?>'); return false;"><?=(strlen($arResult["CURRENT_SESSION_ARRAY"]["NAME"]) ? $arResult["CURRENT_SESSION_ARRAY"]["NAME"] : $arResult["DEFAULT"]["NAME"]);?></a>
	</div>
	<div id="vregions-sepia" onclick="OpenVregionsPopUp('close'); return false;"></div>
	<? if ($arParams["SHOW_POPUP_QUESTION"] == "Y"){ ?>
		<div class="vr-popup vregions-popup-que" id="vregions-popup-que<?=$rand;?>">
			<div class="popup-white">
				...
				<div class="vregions-que-body clearfix">
					...
					<a href="#"
					   onclick="OpenVregionsPopUp('open', 'vregions-popup<?=$rand;?>');"><?=GetMessage("NO");?></a>
				</div>
			</div>
		</div>
	<? } ?>

...
<section class="form-order">
	<h3><?=GetMessage('SOA_TEMPL_BUYER_INFO')?></h3>
...
<section class="form-order">
	<h3><?=$arResult['DISPLAY_PROPERTIES']['PAYMENT_E']['NAME']//GetMessage("SOA_TEMPL_PAY_SYSTEM")?></h3>
...
<section class="form-order ys-delivery">
	<h3><?=$arResult['DISPLAY_PROPERTIES']['DELIVERY_E']['NAME']//GetMessage("SOA_TEMPL_PAY_SYSTEM")?></h3>
...
<footer class="footer-order row form-order basket-big">
	...
	<div class="buy-block col-sm-6 clearfix">
		...
		<button onclick="return YS_Validate()" class="main-btn make-order"><?=GetMessage("ORDER");?></button>
	</div>

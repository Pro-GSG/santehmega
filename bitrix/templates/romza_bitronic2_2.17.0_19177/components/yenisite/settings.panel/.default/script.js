$(document).ready(function () {
	...
	var presets = {
		...
		'block_detail-similar-price': {easy: false, medium: false, hard: true},
		'block_detail-recommended':   {easy: false, medium: false, hard: true},
		...
		'block_search-recommend':  {easy: false, medium: false, hard: true},
		// 404
		'block_404-viewed':     {easy: false, medium: true,  hard: true},
		'block_404-bestseller': {easy: false, medium: false, hard: true},
		'block_404-recommend':  {easy: false, medium: false, hard: true},
	};
	b2.rel.preset = [];

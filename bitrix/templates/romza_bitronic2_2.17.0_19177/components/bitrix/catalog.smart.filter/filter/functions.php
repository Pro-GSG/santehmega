					...
					<div class="range-slider-inputs">
						<label class="filter-input-wrap start">
							...
							<input 
								...
								data-range-min="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>" <?if(!$bSlider):?>placeholder="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>"<?endif?>
							>
						</label>
						<label class="filter-input-wrap end">
							...
							<input 
								...
								size="5"
								onkeyup="smartFilter.keyup(this)"
								data-range-max="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>" <?if(!$bSlider):?>placeholder="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>"<?endif?>
							>
							<?if(isset($arItem["PRICE"])):?>

...
$MESS["RESIZER_NEWS_LIST"] = "Фото в списке";
$MESS["RESIZER_NEWS_DETAIL"] = "Фото детальное";
// Related items
$MESS["RELATED_HEADER_TEXT"] = "Заголовок для блока с товарами";
$MESS["RELATED_HEADER_TEXT_DEFAULT"] = "Связанные товары";
?>
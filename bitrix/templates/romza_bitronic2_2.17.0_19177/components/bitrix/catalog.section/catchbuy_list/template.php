...
<div class="hurry container wow fadeIn">
	<?
	...
	?>
	<div id="hurry-carousel" class="hurry-carousel wow fadeIn">
...
<? $frame->end() ?>
						...
						<div class="economy">
							...
							<span class="value" id="<?=$arItemIDs['DISCOUNT_DIFF']?>">
...
<? $frame->end() ?>
	...
	if ($arJsCache['file']):?>
		...
		<script src="<?= $arJsCache['path'], '/', $arJsCache['idJS'], '?', @filemtime($arJsCache['path-full'])?>"></script><?
	else:?>

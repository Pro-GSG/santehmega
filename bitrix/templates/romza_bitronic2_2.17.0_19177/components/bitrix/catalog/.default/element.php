...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"USE_CAPTCHA" => ($GLOBALS['USER']->IsAuthorized() ? "N" : "Y"),//$arPrepareParams['USE_CAPTCHA'],
...
if (CModule::IncludeModule('sale') && CModule::IncludeModule('edost.catalogdelivery')) {
	...
	$arEdostParams['price_value'] = 'max';
	$arEdostParams['attract_price'] = '19999|29999'; // при экономном расчете притягивать округленную цену к указанным значениям (здесь необходимо перечислить суммы от которых действует скидка с доставки)

...
<?//START Вывод кнопки "Выбрать комплектацию" #TICKET_13273
					if (isset($arResult['OFFERS']) && !empty($arResult['OFFERS']))
					{
					...
					?>
						<div id="<? echo $arItemIDs['OFFER_GROUP'].$offerID; ?>" style="display: none;">
							<?$modalId = 'modal_custom-collection' . $offerID;?>
					
							<div style="margin-bottom:20px; margin-top:20px; text-align:center;">
								<a href="#" class="custom-collection" data-toggle="modal" data-target="#<?=$modalId?>" data-id="<?=$offerID?>">
										<button type="button" class="btn-big btn-main" style="width: 90%; 
												max-width: 400px; 
					...
					else
					{
						...
						{
					?>
					<?$modalId = 'modal_custom-collection' . $arResult["ID"];?>
					
							<div style="margin-bottom:20px; margin-top:20px; text-align:center;">
								<a href="#" class="custom-collection" data-toggle="modal" data-target="#<?=$modalId?>" data-id="<?=$arResult["ID"]?>">
										<button type="button" class="btn-big btn-main" style="width: 90%; 
												max-width: 400px; 
												height: 50px; padding-top: 5px; 
												padding-bottom: 5px; 
					...
					//END Вывод кнопки "Выбрать комплектацию" #TICKET_13273?>

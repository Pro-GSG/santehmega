	...
	<table class="table_product-modifications" id="<?=$arItemIDs['SKU_TABLE']?>">
		...
		<tbody>
			<?foreach($arResult['OFFERS'] as $arOffer):
				...
				?>
				<tr<?=($availableClass ? ' class="'.$availableClass.'"' : '')?>>
					<td class="name">
					...
					<td class="price"><?
						...
						<span class="price-new"><?=CRZBitronic2CatalogUtils::getElementPriceFormat($arOffer['MIN_PRICE']['CURRENCY'],$arOffer['MIN_PRICE']['DISCOUNT_VALUE'], $arOffer['MIN_PRICE']['PRINT_DISCOUNT_VALUE'])?></span><?
						endif?>
						...
						*/
						...
						<?if($arOffer['CAN_BUY']):?>
							...
							<span class="quantity-counter">
								...
								<button type="button" class="btn-silver quantity-change decrease disabled"><span class="minus">&ndash;</span></button>

...
$MESS["CP_BC_HIDE_NOT_AVAILABLE"] = "В доп.слайдерах (детальная, поиск, 404) не отображать товары, которых нет на складах";
...
$MESS['BITRONIC2_LIST_SORT_PROPS'] = 'Дополнительные характеристики товаров для сортировки';

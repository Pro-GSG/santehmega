...
?>
<div class="collection-wrap row wow fadeIn">
							...
							<div class="buy-block-main">
								<div class="buy-block-content">
									...
									<div class="product-main-photo">
										<img src="<?=$arResult['ELEMENT']['PICTURE_PRINT']['SRC']?>" alt="<?=$arResult['ELEMENT']['NAME']?>">
									</div>
									<div class="price-wrap" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
										<div class="price-values">
											...
											<div class="price">
												<meta itemprop="price" content="<?=$arResult['ELEMENT']['PRICE_DISCOUNT_VALUE']?>">
												<meta itemprop="priceCurrency" content="<?=$arResult['ELEMENT']['PRICE_CURRENCY']?>">

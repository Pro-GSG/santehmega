...
?><h2><?=GetMessage('BITRONIC2_CATALOG_SET_CONSTRUCT')?>:</h2>
		<div class="custom-collection-content">
			...
			<div class="product"
				...
				<div class="item-photo">
					<img src="<?=htmlspecialcharsbx($arCurElementInfo['PICTURE_PRINT']['SRC'])?>" alt="<?=htmlspecialcharsbx($arCurElementInfo['NAME'])?>">
				</div>
				...
				<?foreach($arSetElementsDefault as $arItem):?>
					...
					<div class="item-wrap">
						<div class="item"
							...
							<div class="item-photo">
								<img src="<?=htmlspecialcharsbx($arItem['PICTURE_PRINT']['SRC'])?>" alt="<?=htmlspecialcharsbx($arItem['NAME'])?>">
							</div>
							<div class="item-main-data">
								<div class="name-wrap">
		...
		<div class="items-to-choose-from">
			<h2><?=GetMessage('BITRONIC2_CATALOG_SET_POPUP_TITLE')?></h2>

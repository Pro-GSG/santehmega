...
<?$this->SetViewTarget('bitronic2_modal_register');*/?>
		<form method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform" enctype="multipart/form-data" class="form_registration" id="modal_form_registration">
			...
			<h2><span class="header-text"><?=GetMessage("BITRONIC2_AUTH_REGISTER")?><span class="hidden-xs"><?=GetMessage('BITRONIC2_REGISTER_IN_OUR_SHOP')?></span></span></h2>
			...
			*/?>
			...
			<label class="checkbox-styled">
				<input type="checkbox" name="accept-agreement" id="accept-agreement" <?=(isset($_POST['accept-agreement']) && $_POST['accept-agreement'] == 'Y') ? " checked=\"checked\"" : ""?> value="Y" tabindex="<?=$tabindex++?>">
				<span class="checkbox-content" tabindex="<?=$tabindex++?>">
					<i class="flaticon-check14"></i>
					<?=GetMessage("BITRONIC2_REGISTER_I_ACCEPT")?> <a target="_blank" href="<?=$arParams['URL_SHOP_RULES']?>"><?=GetMessage("BITRONIC2_REGISTER_SHOP_RULES")?></a>
				</span>
			</label>
			...
			<div class="textinput-wrapper submit-wrap">
				<button type="submit" class="btn-submit btn-main" name="Register" tabindex="<?=$tabindex++?>" value="Y">

					...
					<table class="table_totals">
						...
						if (strlen($arResult["PAYED_FROM_ACCOUNT_FORMATED"]) > 0)
						{
							...
							<tr>
								...
								<td class="value" class="price"><?=CRZBitronic2CatalogUtils::getElementPriceFormat($arResult["BASE_LANG_CURRENCY"], $orderTotalSum, $arResult['ORDER_TOTAL_PRICE_FORMATED'])?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="value fwb" class="price"><?=CRZBitronic2CatalogUtils::getElementPriceFormat($arResult["BASE_LANG_CURRENCY"], $arResult['ORDER_TOTAL_LEFT_TO_PAY'], $arResult['ORDER_TOTAL_LEFT_TO_PAY_FORMATED'])?></td>
							</tr>
							<?
						}
						else

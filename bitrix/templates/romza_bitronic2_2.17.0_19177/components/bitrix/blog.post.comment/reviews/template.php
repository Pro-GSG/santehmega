					...
					{	
						...
						?>
							<div class="when-authorized user-info">
								<div class="avatar">
									<img src="<?=CResizer2Resize::ResizeGD2($user_ava,$arParams['RESIZER_COMMENT_AVATAR'])?>" alt="<?=$arResult["User"]['NAME']?>">
								</div>
					...
					*/
					...
					<div class="form-footer">
						...
						if($arResult["use_captcha"]===true)
						{
							...
							<label for="comment-captcha-input"><?=GetMessage("B_B_MS_CAPTCHA_SYM")?><span class="required-asterisk">*</span>:</label>
